...
<div class="layui-container layadmin-cmdlist-fluid">
    <div class="layui-row" style="margin: 0px auto;margin-bottom: 20px; border: 2px dashed #ccc;padding: 10px">
        <c:forEach items="${sorttypeList}" var="item" varStatus="ss">
            <div style="border: 1px solid #ccc;margin:4px;padding: 0px;display: inline-block;">
                <div class="layui-bg-blue " style="margin:3px;padding: 5px 8px;  text-align: center;"><a
                    ...
                    <a href="javascript:;">
                        <div class="cmdlist-text">
                            ...
                            <div class="price">
                                ...
                                <c:choose>
                                    <c:when test="${fn:length(item.type) > 6}">
                                        <c:out value="${fn:substring(item.type, 0, 6)}." />
                                    </c:when>
                                    <c:otherwise>
