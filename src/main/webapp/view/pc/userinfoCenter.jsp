...
<div class="layui-container layadmin-cmdlist-fluid">
    <div class="layui-row layui-col-space30">
        ...
        <div class="layui-col-md9" style="border: 0px solid red;height: auto;margin-top: 15px;">
            ...
            <form class="layui-form layui-form-pane" action="" style="width:80%;margin:0 auto;margin-top: 2%;"
                ...
                <c:set value="${fn:split(userinfo.role, ',') }" var="names"/>

                <div class="layui-form-item ">
                    <label class="layui-form-label">标签</label>
                    <div class="layui-input-block">
                        <input type="text" id="roleshow" name="roleshow"
                               value="${userinfo.role}" class="layui-input" readonly/>
                    </div>
                </div>

                <div class="layui-form-item " style="border: 1px #cccccc dashed;">
